#ifndef ColorSelectorFunction_h
#define ColorSelectorFunction_h
...
/// <summary>
/// This class defines the functionality for selecting the color of the light.
/// </summary>
class ColorSelectorFunction : public CraftLightFunction
{
  public:
    /// <summary>
    ...
    ColorSelectorFunction(Adafruit_NeoPixel& pixels);
